...
species_total_suitable_areas <- function(species, temp_min, temp_max, depth_min, depth_max) {
  ...
  species_mask <- crop(species_homes, eez)
  ...
  tmap_mode('plot')
  #Create a map to plot the suitable area in m^2
  total_area_species_map <- tm_shape(species_zonal_stats) +
    tm_polygons(fill = 'suitable_area_m2',
                fill_alpha = 0.6,
                palette = 'BuPu',
  ...
  #Create a map to plot the percent of suitable area 
  tmap_mode('plot')
  percent_area_species_map <- tm_shape(species_zonal_stats) +
    tm_polygons(fill = 'pct_suitable', 
                fill_alpha = 0.6,                             
                values = 'SunsetDark',
                fill.scale = tm_scale(breaks = c(0, 0.25, 1.25, 2.25, 5, 100)), # bins
...
species_total_suitable_areas("Squid",
                             temp_min = 10, 
                             temp_max = 15, 
                             depth_min = -180,
                             depth_max = -20)
