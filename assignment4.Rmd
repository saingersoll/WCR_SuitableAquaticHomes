...
tm_shape(zonal_stats_rast) +
  tm_polygons(fill = 'suitable_area',
              fill_alpha = 0.6,
              palette = 'BuPu',                      # Add Color scheme# Add geometry, opacity, lable
...
tm_shape(zonal_stats_rast) +
  tm_polygons(fill = 'suitable_area', 
              fill_alpha = 0.6, 
              palette = 'BuPu',
              fill.legend = tm_legend(title = 'Suitable Area (m^2)') +     
...
tm_shape(zonal_stats_rast) +
  tm_polygons(fill = 'pct_suitable_m2', 
              fill_alpha = 0.6,                                             # Add geometry and opacity
               # Add breaks, and legend title
                                    values = 'BuPu',                       # Add Color scheme
              fill.legend = tm_legend(title = 'Percent Suitable Area (m^2)')) +     # Add legend title
...
species_total_suitable_areas <- function(species, temp_min, temp_max, depth_min, depth_max) {
  ...
  sst_species <- raster::classify(mean_sst_stack_c,
                            rcl = rcl_temp)
  ...
  depth_species <- raster::classify(depth,
                              rcl = rcl_depth)
  ...
  pct_suitable_area_fun <- (total_suitable_areas / eez$area_m2) * 100
