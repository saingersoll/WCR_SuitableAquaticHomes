...
sst_08 <- st_transform(sst_08, crs = "EPSG:4326")
crs(sst_08)
summarize(sst_08)
...
# raster stack as SpatRaster object
sst_stack <- rast(crs = "EPSG:4326",
                  files_list) 

sst_stack

# POTENTIAL USE
#terra::writeRaster(sst_stack, "data/"file_lists, filetype = "GTiff", #overwrite = TRUE)

# BUNK CODE
#terra::writeRaster(nlayers = files_list,
 #           file.path(here("data/"),
  #                    names(t)),
   #         format = "GTiff",
    #        bylayer = TRUE
...
# Matching CRS
# likely need to project the SpatRaster
sst_stack <- st_transform(sst_stack, 
                          crs = "4326")
depth <- st_transform(depth,
                      crs = "4326")

# Confirming reprojection successful
